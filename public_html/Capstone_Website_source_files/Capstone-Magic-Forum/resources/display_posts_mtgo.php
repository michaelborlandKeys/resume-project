...
if ($query_result->num_rows > 0) {
    ...
    while($forum_post = $query_result->fetch_assoc()) {
      echo "<p>". " ".$forum_post_id." " .$forum_post['user_post_ID']. " ".$post_by_line."". $post_username_temp. "<br />"."<br />". $forum_post['user_mtgo_post']."<br />"."<br />".$date_time." ". $forum_post['user_time_mtgo']."<br />"."</p>";
} else {
